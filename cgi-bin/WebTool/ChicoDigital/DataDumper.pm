...
package ChicoDigital::DataDumper;
...
#bootstrap Data::Dumper; do not use C-compiled module.
...
#
sub Dumper {
  return ChicoDigital::DataDumper->Dump([@_]);
}

sub Dumpf { return ChicoDigital::DataDumper->Dump(@_) }

sub Dumpp { print ChicoDigital::DataDumper->Dump(@_) }
